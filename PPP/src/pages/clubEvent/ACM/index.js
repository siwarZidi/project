...
const photos = [
  ...
  { src: photo3, name: "Trésorier", contact: "ines@insat.ucar.tn" },
      ...
      <div style={{ position: "relative", width: "100%", height: "450vh", overflow: "hidden" }}>
        ...
        >
          <video
            ...
            loop
            muted
            style={{ minWidth: "100%", minHeight: "100%", width: "auto", height: "auto", objectFit: "cover" }}
          >
              ...
              >
                ...
                <Grid container item xs={11} spacing={3} alignItems="center" sx={{ mx: "auto" }}>
                  ...
                  <Grid item xs={12} lg={7} sx={{ ml: "auto" }}>
                    ACM (Association for Computing Machinery) INSAT Tunis is the student chapter of the ACM at the
                    National Institute of Applied Science and Technology (INSAT) in Tunis, Tunisia. This chapter is part
                    of a global network of ACM student chapters that aim to promote computer science and IT education,
                    foster professional development, and provide networking opportunities for students.
                    <br />
                    <br />
                    Check out our news
                    <br />
                  ...
                  <Grid item xs={12} lg={4} sx={{ mx: "auto" }}>
                    🚀 L'événement Code Quest, organisé par le chapitre étudiant de l'ACM à l'INSAT, s'est déroulé le 10
                    décembre 2023. Cette journée dédiée à l'informatique et à l'échange de connaissances a offert un
                    ...
                    <Container component="main" maxWidth="sm" className="App">
                      <Box className="contact-form-container">
                        ...
                        <Box component="form" onSubmit={handleSubmit} sx={{ mt: 3 }}>
                          ...
                          <Button type="submit" fullWidth variant="contained" className="contact-form-button">
                            Send Message
                          </Button>
                        </Box>
                      </Box>
