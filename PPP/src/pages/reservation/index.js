        ...
        <Grid container spacing={1} justifyContent="center" alignItems="center" height="100%">
          <Grid item xs={11} sm={9} md={5} lg={4} xl={3}>
            <Card>
              ...
              <FormGroup>
          <MKInput type="text" label="CLub's Name" fullWidth value={clubname} onChange={(e) => setclubname(e.target.value)}  />
          </FormGroup>
          <FormGroup>
          <MKInput type="text" label="class Name" fullWidth value={classname} onChange={(e) => setclassname(e.target.value)}  />
          </FormGroup>
          <FormGroup>
             <MKInput type="date" fullWidth value={date}  onChange={(e) => setdate(e.target.value)}  />
          </FormGroup>
          <FormGroup>
          <MKInput type="time" fullWidth value={time} onChange={(e) => settime(e.target.value)}  />
          </FormGroup>
